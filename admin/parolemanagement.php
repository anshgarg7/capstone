                    ...
                    <div class="card-body p-0">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $jailId = 1;
                                $inmates = getThis("SELECT `id`, `inmateID`, `dateOfParole`, `durationOfParole` FROM `parolemanagement` WHERE `jailId`='$jailId' AND `paroleRequestStatus`='1'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?>
                                        <td><?php echo $inmateDetails['firstName'] . " " . $inmateDetails['lastName']; ?></td>
                                        <td><?php echo $inmateDetails['idProofNumber']; ?></td>
                                        <td><?php echo $inmate['dateOfParole']; ?></td>
                                        <td><?php echo $inmate['durationOfParole']; ?></td>
